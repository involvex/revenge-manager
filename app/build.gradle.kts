...
android {
    namespace = "app.involvexcord.manager"
    compileSdk = 34

    defaultConfig {
        applicationId = "app.involvexcord.manager"
        minSdk = 28
        targetSdk = 34
        ...
        buildConfigField("String", "MOD_NAME", "\"Involvexcord\"")
        buildConfigField("String", "MANAGER_NAME", "\"InvolvexcordManager\"")
        buildConfigField("String", "REPO", "\"Involvexcord-mod/bundle\"")
        ...
        buildConfigField("String", "MODDED_APP_PACKAGE_NAME", "\"app.involvexcord\"")
